...
- [The Case for Markup Languages for Typesetting](#1)
  * [Markup and Typesetting](#2)
  * [WYSIWYG *vs* WYSIWYM](#3)
  * [Common Markup Languages](#common-markup-languages-4)
    + [**html**](#html-5)
    + [LaTeX](#latex-6)
    + [Markdown](#markdown-7)
- [The Simplicity of Markdown](#the-simplicity-of-markdown-8)
- [An Introduction to _pandoc_](#an-introduction-to--pandoc-9)
  * [Pandoc: a universal markup interconversion tool](#pandoc--a-universal-markup-interconversion-tool-11)
    + [Installing _pandoc_ and other useful tools](#installing--pandoc--and-other-useful-tools-12)
  * [Your first _pandoc_ conversion](#your-first--pandoc--conversion-13)
  * [Converting to _Microsoft_ _Word_ .docx from Markdown](#converting-to--microsoft---word--docx-from-markdown-14)
  * [Advanced: Putting in your Markdown](#advanced--putting---latex--)
    + [![LaTeX](https://latex.codecogs.com/gif.latex?\LaTeX) Symbols](#--latex--https---latexcodecogscom-giflatex--latex--symbols)
    + [![LaTeX](https://latex.codecogs.com/gif.latex?\LaTeX) inline Typesetting](#--latex--https---latexcodecogscom-giflatex--latex--inline-typesetting)
